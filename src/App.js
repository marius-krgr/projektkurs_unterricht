        ...
        <React.Fragment>
          <div className="ui container">
            <div className="ui menu">
              ...
              <Link to="/important" className="item">
                Important!
              </Link>
              <Link to="/actionButton" className="item">
                Action Button
              </Link>
              <Link to="/rechnen" className="item">
                Rechnen
              </Link>
              <Link to="/verdoppeln" className="item">
                Verdoppeln
              </Link>
              <Link to="/temperaturen" className="item">
                Temperaturen
              </Link>
              <Link to="/vertretungsplan" className="item">
                Vertretungsplan
              </Link>
              <Link to="/brewery-api" className="item">
                Brewery-Api
              </Link>
              <Link to="/todo" className="item">
                Todo
              </Link>
              <Link to="/todoredux" className="item">
                TodoRedux
              </Link>
              <Link to="/todoj" className="item">
                TodoJ
              </Link>
            </div>
            ...
            <div className="ui segment">
              ...
              <Route path="/important">
                ...
                <div className="ui raised segment">
                  Important Message: Hi there! Oh yeah es funktionuggelt
                  yaaahhhh!!!
                </div>
              </Route>
