...
const todoSlice = createSlice({
  ...
  reducers: {
    ...
    addTodo(state, action) {
      ...
      state.todos.push({ done: false, id: state.nextId, title: title, working: false});
      state.nextId += 1;
...
export const { addTodo, removeTodo, toggleDone, updateTitle, editWorking, loadFromStorage } =
  todoSlice.actions;
